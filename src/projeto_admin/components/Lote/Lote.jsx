                ...
                <>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="input-group w-25">
                            ...
                            <input type="number" value={preco} onChange={handlePriceChange} required name={"valorIngresso"} min={0} className="form-control w-25" placeholder={10} />
                        </div>
                    </div>
                </>
            )}
                ...
                <>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="input-group">
                            <span className="input-group-text" id="inputGroup">R$</span>
                            <input type="number" value={preco} onChange={(e) => setPreco(e.target.value)} required name={"valorIngresso"} min={0} className="form-control w-25" placeholder={10} />
                        </div>
                    </div>
                </>
            )}
